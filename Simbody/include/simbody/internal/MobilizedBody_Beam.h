...
The first two rotations induce translations according to the Euler-Bernoulli
beam deflection formula for a cantilever beam under a transverse point load
applied at the end of the beam. The estimated displacement of the beam's
endpoint in the Fz direction is based on equation 8.1-14 from [1]. The third
rotation induces a rotation about the Mz axis, which is always tangent to the
beam at the beam's endpoint.
